...
(* Variable Symbols *)
type vsymbol = { vs_name : Ident.t; vs_ty : ty } [@@deriving show, sexp_of]
...
(* let sexp_of_lsymbol l = Ident.sexp_of_t l.ls_name start here*)
...
module LS = struct
  ...
  let t_of_sexp = lsymbol_of_sexp
  let sexp_of_t = sexp_of_lsymbol
end
